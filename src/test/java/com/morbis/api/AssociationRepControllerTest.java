...
public class AssociationRepControllerTest {
    ...
    public void getLeagues() throws UnsupportedEncodingException {
        MvcResult response = makeGetRequest("/api/rep/leagues", apiMock);
    ...
    public void getScoringMethods() throws UnsupportedEncodingException {
        MvcResult response = makeGetRequest("/api/rep/scoring-methods", apiMock);
        assertThat(response.getResponse().getStatus()).isEqualTo(HttpStatus.OK.value());
        assertThat(response.getResponse().getContentAsString())
                .contains(
    ...
    public void getSchedulingMethods() throws UnsupportedEncodingException {
        MvcResult response = makeGetRequest("/api/rep/scheduling-methods", apiMock);
        assertThat(response.getResponse().getStatus()).isEqualTo(HttpStatus.OK.value());
        assertThat(response.getResponse().getContentAsString())
                .contains(
    ...
    public void updatePolicy() {
        ...
        MvcResult response = makePostRequest("/api/rep/update-policy", apiMock,
